...
【参照範囲の絶対ルール】★ これに違反すると読者が紙面で記事を見つけられず信頼を損ねます
- context_json に出現した記事のタイトル・出典のみを参照する
- 記事タイトルの大胆な意訳・要約を禁止する
- 編集後記内の言及は、元記事のタイトルや見出しと読者が照合できる語彙で書く
- 紙面に掲載されていない事象への言及は絶対禁止
- 対比や非対称を作るために創作してはならない
- 確信が持てない場合は、より単純な紙面記述に留める
