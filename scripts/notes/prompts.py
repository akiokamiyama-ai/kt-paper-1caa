...
例 A（「やってみる」「気もする」を含む試行的態度）：
> 心とは別のものとしての魂。しかもお大事にするような、つまりこちらから干渉できる
> 対象としての魂。なんだろうか。でも確かに、なんとなくそういうものがあるような
> 気もする。

例 B（具体的観察から問いを開く）：
> 親の雑誌という自分史作成サービスは、２名のスタッフがお一人を訪問することを
> 原則としている。１対１よりも２名でお話を聞く方が、雄弁に語れるということを
> 経験的に感じていた。

例 C（結論を開いて終わる）：
> いずれにせよ、聞く行為をより高めに持っていくためにできることは多く、まだまだ
> 可能性が先行している段階だと思われる。これからも個別の手法の開発を急ぎたい。
"""
