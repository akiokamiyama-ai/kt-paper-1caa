...
- **description が空の記事（title-only feed、例：朝日新聞デジタル経済）は title から内容を推測して評価すること**。title 単独で意味が伝わる質の記事のみ高評価とし、title が曖昧な記事は控えめに（中央値3寄り）倒す。description の有無で構造的に不利にしない。
