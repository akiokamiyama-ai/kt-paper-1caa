...
#### 7. Literary Hub（LitHub）✅
- **URL**: https://lithub.com/
- **RSS**: https://lithub.com/feed（C125 検証時に 200 OK、application/rss+xml、items 10、7/2 直近配信確認）
- **language**: en
- **形式**: RSS 2.0
- **mainstream**: true
- **対象**: 米国の書評・文学ポータル。書評、著者インタビュー、リストキュレーション、ノンフィクション紹介、独立系出版社ベストセラー等の総合媒体
- **位置付け**: C125 (Sprint 11, 2026-07-04) 追加。**The Paris Review 独占（過去採用の 50%）の緩和** が目的。Paris Review が「作家インタビューの最高峰」なのに対し、LitHub は「日次の文学ポータル」で分担。神山さんの多様な文学関心（現代英米文学、翻訳文学、ノンフィクション横断）に日次で応える供給源。Words Without Borders (#6, 翻訳文学特化) との重複回避は、LitHub が英米中心の総合媒体、WWB が翻訳文学特化で分担できる
